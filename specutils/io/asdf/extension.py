...
def get_extensions():
    ...
    from specutils.io.asdf.tags.spectra import SpectralAxisConverter, Spectrum1DType, SpectrumListType

    SPECUTILS_TRANSFORM_CONVERTERS = [SpectralAxisConverter(), Spectrum1DType(), SpectrumListType()]
